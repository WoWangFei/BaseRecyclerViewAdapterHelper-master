...
import com.xzh.recyclerview.base.BaseHeaderAdapter;
import com.xzh.recyclerview.bean.PinnedHeaderEntity;
import com.xzh.recyclerview.callback.OnHeaderClickListener;
import com.xzh.recyclerview.utils.Utils;
import com.xzh.recyclerview.viewholder.PinnedHeaderItemDecoration;
                    ...
                    case BaseHeaderAdapter.TYPE_DATA:
                        ...
                        if (mRecyclerView.getLayoutManager() instanceof StaggeredGridLayoutManager) {
                            ...
                            if (mRandomHeights.get(position) == 0) {
                                mRandomHeights.put(position, Utils.dp2px(MainActivity.this, (int) (100 + Math.random() * 100)));
                            }
